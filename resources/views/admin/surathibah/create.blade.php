<x-app-layout>
    <div class="mb-4 text-center">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Surat Hibah Tanah</h2>
    </div>
    <div class="max-w-full px-4 sm:px-6 lg:px-8">
        ...
        @endif
        <form action="{{ route('surathibah.store') }}" method="POST" class="shadow-md rounded-lg p-6">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-2">
                    <label for="pemberi" class="block mb-2 text-gray-700">Pemberi</label>
                    <input type="text" id="pemberi" name="pemberi"
                        class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500"
                        required>
                </div>
                <div class="mb-2">
                    <label for="penerima" class="block mb-2 text-gray-700">Penerima</label>
