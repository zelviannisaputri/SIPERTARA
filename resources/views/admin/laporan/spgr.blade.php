...
<head>
    <title>Laporan Surat Pernyataan Ganti Rugi (SPGR) Tanah</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content">
        <h1 style="text-align: center;">Surat Pernyataan Ganti Rugi (SPGR) Tanah</h1>
        <table>
            <thead>
                <tr>
                    <th>No</th>
