<x-app-layout>
    <div class="mb-4 text-center">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Surat Keterangan Pendaftaran Tanah (SKPT)</h2>
    </div>
    <div class="max-w-full px-4 sm:px-6 lg:px-8">
        ...
        @endif
        <form action="{{ route('skpt.store') }}" method="POST" class="shadow-md rounded-lg p-6"> @csrf
